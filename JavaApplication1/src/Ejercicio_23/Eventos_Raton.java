 ...
 * @author sonfil
 */
public class Eventos_Raton extends javax.swing.JFrame {
        JLabel etiTexto;
        JLabel etiZona;
    /**
     * Creates new form Eventos_Raton
     */
    ...
    public void etiZonaMouseExited(MouseEvent evt){
        etiTexto.setText("El ratón acaba de salir en la etiqueta");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eventos_Raton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
